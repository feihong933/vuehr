    ...
    <div>
        <div style="display: flex;justify-content: space-between">
            <div>
                ...
                <el-button size="small" icon="el-icon-search" type="primary" @click="initEmps"
...
<!--                </el-button>-->
            ...
            <div>
                <el-upload
                    ...
                    <el-button size="small" :disabled="importDataDisabled" type="success" :icon="importDataBtnIcon">
                        {{importDataBtnText}}
                    </el-button>
                </el-upload>
                        ...
                        <el-col :span="6">
                            <el-form-item label="所属部门:" prop="departmentId">
                                <el-popover
                                    ...
                                    <div slot="reference"
                                         style="margin-top:8px; width: 150px;display: inline-flex;font-size: 13px;border: 1px solid #dedede;height: 26px;border-radius: 5px;cursor: pointer;align-items: center;padding-left: 8px;box-sizing: border-box"
...
<script>
    export default {
        ...
        methods: {
            ...
            initEmps() {
                this.loading = true;
                let url = '/employee/basic/?page=' + this.page + '&size=' + this.size + '&keyword=' + this.keyword;
